...
import { oneLiners, priorities } from './constants';
import { buildSchedule } from './utils/scheduler';
import { getTimetable } from './utils/processTimetable';

const FestivalScheduler = () => {
  const fetchedTimetable = getTimetable()
  ...
  const { clashes, schedule, missedBands } = useMemo(() => buildSchedule(fetchedTimetable, priorities), []);
...
export default FestivalScheduler;
